...
$sTargetDir			= $sTargetBaseDir . '/include';
...
new JS_Files_Minifier( 
	...
	array(
		'header_class_name'	=>	'DiscountByAnswerForEDD_Registry_Base',
		'header_class_path'	=>	$sTargetBaseDir . '/discount-by-answer-for-easy-digital-downloads.php',
		'output_buffer'		=>	true,
		...
		'search'			=>	array(
			...
			// 'exclude_dir_paths'		=>	array( $sTargetBaseDir . '/include/class/admin' ),
			 'exclude_dir_names'		=>	array( 'library', 'css', ),
			'is_recursive'			=>	true,
		),			        
	)
);
