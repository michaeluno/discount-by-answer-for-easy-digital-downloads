...
class DiscountByAnswerForEDD_AdminPageFramework_Property_admin_page extends DiscountByAnswerForEDD_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'discount-by-answer-for-easy-digital-downloads') {
        ...
        $GLOBALS['aDiscountByAnswerForEDD_AdminPageFramework']['aPageClasses'] = $this->getElementAsArray($GLOBALS, array('aDiscountByAnswerForEDD_AdminPageFramework', 'aPageClasses'));
        $GLOBALS['aDiscountByAnswerForEDD_AdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
