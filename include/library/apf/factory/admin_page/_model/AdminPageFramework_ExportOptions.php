...
abstract class DiscountByAnswerForEDD_AdminPageFramework_CustomSubmitFields extends DiscountByAnswerForEDD_AdminPageFramework_FrameworkUtility {
    public $aPost = array();
    public $sInputID;
...
class DiscountByAnswerForEDD_AdminPageFramework_ExportOptions extends DiscountByAnswerForEDD_AdminPageFramework_CustomSubmitFields {
    public $sClassName;
    public $sFileName;
    public $sFormatType;
    public $bIsDataSet;
        ...
        switch (strtolower($sFormatType)) {
            case 'text':
                if (in_array(gettype($vData), array('array', 'object'))) {
                    echo DiscountByAnswerForEDD_AdminPageFramework_Debug::get($vData, null, false);
                }
                echo $vData;
                return;
            case 'json':
