...
abstract class DiscountByAnswerForEDD_AdminPageFramework_Model__FormSubmission_Base extends DiscountByAnswerForEDD_AdminPageFramework_Form_Utility {
...
class DiscountByAnswerForEDD_AdminPageFramework_Model__FormSubmission extends DiscountByAnswerForEDD_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
    public function __construct($oFactory, $aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
        $this->oFactory = $oFactory;
        $this->_handleFormData();
        new DiscountByAnswerForEDD_AdminPageFramework_Model__FormRedirectHandler($oFactory);
    }
    public function _handleFormData() {
        ...
        new DiscountByAnswerForEDD_AdminPageFramework_Model__FormSubmission__Validator($this->oFactory);
