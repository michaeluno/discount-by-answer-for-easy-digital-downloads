...
class DiscountByAnswerForEDD_AdminPageFramework_Model__FormSubmission__Validator_Base extends DiscountByAnswerForEDD_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
...
class DiscountByAnswerForEDD_AdminPageFramework_Model__FormSubmission__Validator extends DiscountByAnswerForEDD_AdminPageFramework_Model__FormSubmission__Validator_Base {
    public $oFactory;
    ...
    public function _replyToValidateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
        ...
        $_aClassNames = array('DiscountByAnswerForEDD_AdminPageFramework_Model__FormSubmission__Validator__Link', 'DiscountByAnswerForEDD_AdminPageFramework_Model__FormSubmission__Validator__Redirect', 'DiscountByAnswerForEDD_AdminPageFramework_Model__FormSubmission__Validator__Import', 'DiscountByAnswerForEDD_AdminPageFramework_Model__FormSubmission__Validator__Export', 'DiscountByAnswerForEDD_AdminPageFramework_Model__FormSubmission__Validator__Reset', 'DiscountByAnswerForEDD_AdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'DiscountByAnswerForEDD_AdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'DiscountByAnswerForEDD_AdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm',);
        ...
        try {
            ...
            $_oFormSubmissionFilter = new DiscountByAnswerForEDD_AdminPageFramework_Model__FormSubmission__Validator__Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);
