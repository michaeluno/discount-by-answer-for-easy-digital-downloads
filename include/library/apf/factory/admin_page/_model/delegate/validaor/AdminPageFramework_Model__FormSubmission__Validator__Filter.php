...
class DiscountByAnswerForEDD_AdminPageFramework_Model__FormSubmission__Validator__Filter extends DiscountByAnswerForEDD_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
