...
class DiscountByAnswerForEDD_AdminPageFramework_Model_Menu__RegisterMenu extends DiscountByAnswerForEDD_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    ...
    public function _replyToRegisterSubMenuItems() {
        ...
        foreach ($_aPages as $_aSubMenuItem) {
            $_oFormatter = new DiscountByAnswerForEDD_AdminPageFramework_Format_SubMenuItem($_aSubMenuItem, $this->oFactory, ++$_iParsedIndex);
