...
class DiscountByAnswerForEDD_AdminPageFramework_Format_InPageTabs extends DiscountByAnswerForEDD_AdminPageFramework_Format_Base {
    ...
    public function get() {
        ...
        foreach (( array )$_aInPageTabs as $_sTabSlug => $_aInPageTab) {
            ...
            $_oFormatter = new DiscountByAnswerForEDD_AdminPageFramework_Format_InPageTab($_aInPageTab, $this->sPageSlug, $this->oFactory);
