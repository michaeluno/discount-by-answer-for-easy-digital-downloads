...
abstract class DiscountByAnswerForEDD_AdminPageFramework_UserMeta_Router extends DiscountByAnswerForEDD_AdminPageFramework_Factory {
...
abstract class DiscountByAnswerForEDD_AdminPageFramework_UserMeta_Model extends DiscountByAnswerForEDD_AdminPageFramework_UserMeta_Router {
    public function _replyToGetSavedFormData() {
        $_iUserID = isset($GLOBALS['profileuser']->ID) ? $GLOBALS['profileuser']->ID : 0;
        $_oMetaData = new DiscountByAnswerForEDD_AdminPageFramework_UserMeta_Model___UserMeta($_iUserID, $this->oForm->aFieldsets);
...
abstract class DiscountByAnswerForEDD_AdminPageFramework_UserMeta_View extends DiscountByAnswerForEDD_AdminPageFramework_UserMeta_Model {
...
abstract class DiscountByAnswerForEDD_AdminPageFramework_UserMeta_Controller extends DiscountByAnswerForEDD_AdminPageFramework_UserMeta_View {
...
abstract class DiscountByAnswerForEDD_AdminPageFramework_UserMeta extends DiscountByAnswerForEDD_AdminPageFramework_UserMeta_Controller {
    protected $_sStructureType = 'user_meta';
    public function __construct($sCapability = 'read', $sTextDomain = 'discount-by-answer-for-easy-digital-downloads') {
