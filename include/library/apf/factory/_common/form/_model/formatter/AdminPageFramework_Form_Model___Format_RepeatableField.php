...
class DiscountByAnswerForEDD_AdminPageFramework_Form_Model___Format_RepeatableSection extends DiscountByAnswerForEDD_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct() {
        ...
        $this->_oMsg = $_aParameters[1] ? $_aParameters[1] : DiscountByAnswerForEDD_AdminPageFramework_Message::getInstance();
    }
    public function get() {
...
class DiscountByAnswerForEDD_AdminPageFramework_Form_Model___Format_RepeatableField extends DiscountByAnswerForEDD_AdminPageFramework_Form_Model___Format_RepeatableSection {
    protected function _getDefaultMessage() {
