...
class DiscountByAnswerForEDD_AdminPageFramework_FieldType_textarea extends DiscountByAnswerForEDD_AdminPageFramework_FieldType {
...
jQuery( document ).ready( function(){
    ...
    var updateFoundEditors = function( oElements ) {
        ...
        oElements.each( function( iIndex ) {
            ...
            var oSettings = jQuery().getDiscountByAnswerForEDD_AdminPageFrameworkInputOptions( oWrap.attr( 'data-id' ) );   
    ...
    jQuery().registerDiscountByAnswerForEDD_AdminPageFrameworkCallbacks( {	
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            var _oSettings = jQuery().getDiscountByAnswerForEDD_AdminPageFrameworkInputOptions( _oWrap.attr( 'data-id' ) );  

            // Elements
            var _oField              = oCloned.closest( '.discount-by-answer-for-easy-digital-downloads-field' );
        ...
        stopped_sorting_fields : function( oSortedFields, sFieldType, sFieldsTagID, iCallType ) { 
            ...
            // Update the editor.
            setTimeout(function(){
                var _oFields = oSortedFields.children( '.discount-by-answer-for-easy-digital-downloads-field' );
        ...
        stopped_sorting_sections: function( oSections ) {
            ...
            setTimeout(function(){
                var _oFields = jQuery( oSections ).find( '.discount-by-answer-for-easy-digital-downloads-field' );
                updateFoundEditors( _oFields );           
            }, 100 );
        ...
        saved_widget : function( oWidget ) { 
            ...
            jQuery( oWidget ).find( '.discount-by-answer-for-easy-digital-downloads-field' ).each( function( iIndex ) {
                ...
                // Store the settings.
                jQuery().storeDiscountByAnswerForEDD_AdminPageFrameworkInputOptions( 
                    oWrap.attr( 'data-id' ), 
                    { 
...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return ".discount-by-answer-for-easy-digital-downloads-field-textarea .discount-by-answer-for-easy-digital-downloads-input-label-string {vertical-align: top;margin-top: 2px;} .discount-by-answer-for-easy-digital-downloads-field-textarea .wp-core-ui.wp-editor-wrap {margin-bottom: 0.5em;}.discount-by-answer-for-easy-digital-downloads-field-textarea.discount-by-answer-for-easy-digital-downloads-field .discount-by-answer-for-easy-digital-downloads-input-label-container {vertical-align: top; float: left;clear: both;} .postbox .discount-by-answer-for-easy-digital-downloads-field-textarea .discount-by-answer-for-easy-digital-downloads-input-label-container {width: 100%;}.discount-by-answer-for-easy-digital-downloads-field-textarea textarea {max-width: 100%;}";
    }
    ...
    private function _getFieldOutputByLabel($sKey, $sLabel, $aField) {
        ...
        $_sClassSelector = $_bIsArray ? 'discount-by-answer-for-easy-digital-downloads-field-textarea-multiple-labels' : '';
        ...
        $_aOutput = array($this->getElementByLabel($aField['before_label'], $sKey, $aField['label']), "<div class='discount-by-answer-for-easy-digital-downloads-input-label-container {$_sClassSelector}'>", "<label for='" . $aField['attributes']['id'] . "'>", $this->getElementByLabel($aField['before_input'], $sKey, $aField['label']), $_sLabel ? "<span " . $this->getLabelContainerAttributes($aField, 'discount-by-answer-for-easy-digital-downloads-input-label-string') . ">" . $_sLabel . "</span>" : '', $this->_getEditor($aField), $this->getElementByLabel($aField['after_input'], $sKey, $aField['label']), "</label>", "</div>", $this->getElementByLabel($aField['after_label'], $sKey, $aField['label']),);
        return implode('', $_aOutput);
    }
...
JAVASCRIPTS;
        return "<script type='text/javascript' class='discount-by-answer-for-easy-digital-downloads-textarea-enabler'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
}
