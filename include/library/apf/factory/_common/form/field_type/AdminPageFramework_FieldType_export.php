...
class DiscountByAnswerForEDD_AdminPageFramework_FieldType_submit extends DiscountByAnswerForEDD_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".discount-by-answer-for-easy-digital-downloads-field input[type='submit'] {margin-bottom: 0.5em;}";
    }
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] || '0' === ( string )$aField['label_min_width'] ? "min-width:" . $this->getLengthSanitized($aField['label_min_width']) . ";" : null, 'class' => 'discount-by-answer-for-easy-digital-downloads-input-label-container' . ' discount-by-answer-for-easy-digital-downloads-input-button-container' . ' discount-by-answer-for-easy-digital-downloads-input-container',);
    }
...
class DiscountByAnswerForEDD_AdminPageFramework_FieldType_export extends DiscountByAnswerForEDD_AdminPageFramework_FieldType_submit {
