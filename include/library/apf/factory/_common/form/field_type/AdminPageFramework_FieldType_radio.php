...
class DiscountByAnswerForEDD_AdminPageFramework_FieldType_radio extends DiscountByAnswerForEDD_AdminPageFramework_FieldType {
    public $aFieldTypeSlugs = array('radio');
    protected $aDefaultKeys = array('label' => array(), 'attributes' => array(),);
    protected function getStyles() {
        return ".discount-by-answer-for-easy-digital-downloads-field input[type='radio'] {margin-right: 0.5em;} .discount-by-answer-for-easy-digital-downloads-field-radio .discount-by-answer-for-easy-digital-downloads-input-label-container {padding-right: 1em;} .discount-by-answer-for-easy-digital-downloads-field-radio .discount-by-answer-for-easy-digital-downloads-input-container {display: inline;} .discount-by-answer-for-easy-digital-downloads-field-radio .discount-by-answer-for-easy-digital-downloads-input-label-string{display: inline; }";
    }
...
jQuery( document ).ready( function(){
    jQuery( 'input[type=radio][data-id=\"{$sInputID}\"]' ).change( function() {
        ...
        jQuery( this ).closest( '.discount-by-answer-for-easy-digital-downloads-field' ).find( 'input[type=radio][data-id=\"{$sInputID}\"]' ).attr( 'checked', false );
