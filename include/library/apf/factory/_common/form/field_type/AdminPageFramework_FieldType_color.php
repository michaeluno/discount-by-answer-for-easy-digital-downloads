...
abstract class DiscountByAnswerForEDD_AdminPageFramework_FieldType_Base extends DiscountByAnswerForEDD_AdminPageFramework_Form_Utility {
    ...
    public function __construct($asClassName = 'admin_page_framework', $asFieldTypeSlug = null, $oMsg = null, $bAutoRegister = true) {
        ...
        $this->oMsg = $oMsg ? $oMsg : DiscountByAnswerForEDD_AdminPageFramework_Message::getInstance();
        if ($bAutoRegister) {
    ...
    protected function getFieldOutput(array $aFieldset) {
        ...
        $_oFieldset = new DiscountByAnswerForEDD_AdminPageFramework_Form_View___Fieldset($aFieldset, $_oCallerForm->aSavedData, $_oCallerForm->getFieldErrors(), $_oCallerForm->aFieldTypeDefinitions, $_oCallerForm->oMsg, $_oCallerForm->aCallbacks);
    ...
    protected function enqueueMediaUploader() {
        ...
        if (function_exists('wp_enqueue_media')) {
            new DiscountByAnswerForEDD_AdminPageFramework_Form_View___Script_MediaUploader($this->oMsg);
        } else {
...
abstract class DiscountByAnswerForEDD_AdminPageFramework_FieldType extends DiscountByAnswerForEDD_AdminPageFramework_FieldType_Base {
    public function _replyToFieldLoader() {
        $this->setUp();
    }
    public function _replyToGetScripts() {
...
class DiscountByAnswerForEDD_AdminPageFramework_FieldType_color extends DiscountByAnswerForEDD_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".repeatable .colorpicker {display: inline;}.discount-by-answer-for-easy-digital-downloads-field-color .wp-picker-container {vertical-align: middle;}.discount-by-answer-for-easy-digital-downloads-field-color .ui-widget-content {border: none;background: none;color: transparent;}.discount-by-answer-for-easy-digital-downloads-field-color .ui-slider-vertical {width: inherit;height: auto;margin-top: -11px;}.discount-by-answer-for-easy-digital-downloads-field-color .discount-by-answer-for-easy-digital-downloads-repeatable-field-buttons {margin-top: 0;}.discount-by-answer-for-easy-digital-downloads-field-color .wp-color-result {margin: 3px;}";
    }
    protected function getScripts() {
        $_aJSArray = json_encode($this->aFieldTypeSlugs);
        $_sDoubleQuote = '\"';
        return <<<JAVASCRIPTS
registerDiscountByAnswerForEDD_AdminPageFrameworkColorPickerField = function( osTragetInput, aOptions ) {
    ...
    var _aDefaults = {
        ...
        change: function( event, ui ){
            jQuery( this ).trigger( 
                'discount-by-answer-for-easy-digital-downloads_field_type_color_changed',
        ...
        clear: function( event, ui ) {
            jQuery( this ).trigger(
                'discount-by-answer-for-easy-digital-downloads_field_type_color_cleared',
    ...
    jQuery().registerDiscountByAnswerForEDD_AdminPageFrameworkCallbacks( {     
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            oCloned.find( 'input.input_color' ).each( function( iIterationIndex ) {
                ...
                registerDiscountByAnswerForEDD_AdminPageFrameworkColorPickerField( _oNewColorInput );                
...
jQuery( document ).ready( function(){
    registerDiscountByAnswerForEDD_AdminPageFrameworkColorPickerField( '{$sInputID}' );
});            
JAVASCRIPTS;
