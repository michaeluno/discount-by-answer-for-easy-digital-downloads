...
class DiscountByAnswerForEDD_AdminPageFramework_FieldType_checkbox extends DiscountByAnswerForEDD_AdminPageFramework_FieldType {
...
jQuery( document ).ready( function(){
    ...
    jQuery( '{$_sClassSelectorSelectAll}' ).each( function(){
        jQuery( this ).before( '<div class=\"select_all_button_container\" onclick=\"jQuery( this ).selectAllDiscountByAnswerForEDD_AdminPageFrameworkCheckboxes(); return false;\"><a class=\"select_all_button button button-small\">' + jQuery( this ).data( 'select_all_button' ) + '</a></div>' );
    });            
    jQuery( '{$_sClassSelectorSelectNone}' ).each( function(){
        jQuery( this ).before( '<div class=\"select_none_button_container\" onclick=\"jQuery( this ).deselectAllDiscountByAnswerForEDD_AdminPageFrameworkCheckboxes(); return false;\"><a class=\"select_all_button button button-small\">' + jQuery( this ).data( 'select_none_button' ) + '</a></div>' );
    });
});
JAVASCRIPTS;
    ...
    private function _getSelectButtonClassSelectors(array $aFieldTypeSlugs, $sDataAttribute = 'select_all_button') {
        ...
        foreach ($aFieldTypeSlugs as $_sSlug) {
            ...
            $_aClassSelectors[] = '.discount-by-answer-for-easy-digital-downloads-checkbox-container-' . $_sSlug . "[data-{$sDataAttribute}]";
        }
        return implode(',', $_aClassSelectors);
    }
    protected function getStyles() {
        return ".select_all_button_container, .select_none_button_container{display: inline-block;margin-bottom: 0.4em;}.discount-by-answer-for-easy-digital-downloads-checkbox-label {margin-top: 0.1em;}.discount-by-answer-for-easy-digital-downloads-field input[type='checkbox' ] {margin-right: 0.5em;} .discount-by-answer-for-easy-digital-downloads-field-checkbox .discount-by-answer-for-easy-digital-downloads-input-label-container {padding-right: 1em;}.discount-by-answer-for-easy-digital-downloads-field-checkbox .discount-by-answer-for-easy-digital-downloads-input-label-string{display: inline; }";
    }
...
class DiscountByAnswerForEDD_AdminPageFramework_FieldType_posttype extends DiscountByAnswerForEDD_AdminPageFramework_FieldType_checkbox {
    ...
    protected function getStyles() {
        ...
        return $_sParentStyles . ".discount-by-answer-for-easy-digital-downloads-field input[type='checkbox'] {margin-right: 0.5em;} .discount-by-answer-for-easy-digital-downloads-field-posttype .discount-by-answer-for-easy-digital-downloads-input-label-container {padding-right: 1em;}";
    }
    protected function getField($aField) {
