...
abstract class DiscountByAnswerForEDD_AdminPageFramework_Form_View___Attribute_Base extends DiscountByAnswerForEDD_AdminPageFramework_Form_Utility {
    public $sContext = '';
...
abstract class DiscountByAnswerForEDD_AdminPageFramework_Form_View___Attribute_FieldContainer_Base extends DiscountByAnswerForEDD_AdminPageFramework_Form_View___Attribute_Base {
    protected function _getFormattedAttributes() {
...
class DiscountByAnswerForEDD_AdminPageFramework_Form_View___Attribute_Field extends DiscountByAnswerForEDD_AdminPageFramework_Form_View___Attribute_FieldContainer_Base {
    public $sContext = 'field';
    protected function _getAttributes() {
        $_sFieldTypeSelector = $this->getAOrB($this->aArguments['type'], " discount-by-answer-for-easy-digital-downloads-field-{$this->aArguments['type']}", '');
        ...
        return array('id' => $this->aArguments['_field_container_id'], 'data-type' => $this->aArguments['type'], 'class' => "discount-by-answer-for-easy-digital-downloads-field{$_sFieldTypeSelector}{$_sNestedFieldSelector}{$_sMixedFieldSelector}{$_sChildFieldSelector}" . $this->getAOrB($this->aArguments['attributes']['disabled'], ' disabled', '') . $this->getAOrB($this->aArguments['_is_sub_field'], ' discount-by-answer-for-easy-digital-downloads-subfield', ''));
    }
}
