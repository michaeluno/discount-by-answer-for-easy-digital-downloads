...
class DiscountByAnswerForEDD_AdminPageFramework_Form_View___Script_Widget extends DiscountByAnswerForEDD_AdminPageFramework_Form_View___Script_Base {
    ...
    $( document ).ready( function() {
        ...
        $( document ).ajaxComplete( function( event, XMLHttpRequest, ajaxOptions ) {
            ...
            if( _aRequest.action && ( 'save-widget' === _aRequest.action ) ) {
                ...
                if ( $( _oWidget ).find( '.discount-by-answer-for-easy-digital-downloads-sectionset' ).length <= 0 ) { 
                    return; 
                }   
                ...
                $( document ).trigger( 
                    'discount-by-answer-for-easy-digital-downloads_saved_widget', 
                    _oWidget 
                );
