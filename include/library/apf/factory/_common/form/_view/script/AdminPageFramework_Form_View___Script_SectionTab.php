...
class DiscountByAnswerForEDD_AdminPageFramework_Form_View___Script_SectionTab extends DiscountByAnswerForEDD_AdminPageFramework_Form_View___Script_Base {
...
jQuery( '.discount-by-answer-for-easy-digital-downloads-section-tabs-contents' ).createTabs(); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='discount-by-answer-for-easy-digital-downloads-section-tabs-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
}
