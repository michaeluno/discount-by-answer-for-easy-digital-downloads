...
class DiscountByAnswerForEDD_AdminPageFramework_Form_View___Script_RepeatableSection extends DiscountByAnswerForEDD_AdminPageFramework_Form_View___Script_Base {
...
( function( $ ) {
     ...
     */
    $.fn.updateDiscountByAnswerForEDD_AdminPageFrameworkRepeatableSections = function( aSettings ) {
    
        var _oThis                = this;
        var _sSectionsContainerID = _oThis.find( '.repeatable-section-add-button' ).first().closest( '.discount-by-answer-for-easy-digital-downloads-sections' ).attr( 'id' );
    
        // Store the sections specific options in an array.
        if ( ! $.fn.aDiscountByAnswerForEDD_AdminPageFrameworkRepeatableSectionsOptions ) {
            $.fn.aDiscountByAnswerForEDD_AdminPageFrameworkRepeatableSectionsOptions = [];
        }
        if ( ! $.fn.aDiscountByAnswerForEDD_AdminPageFrameworkRepeatableSectionsOptions.hasOwnProperty( _sSectionsContainerID ) ) {
            $.fn.aDiscountByAnswerForEDD_AdminPageFrameworkRepeatableSectionsOptions[ _sSectionsContainerID ] = $.extend(
                {    
        ...
        var _aOptions = $.fn.aDiscountByAnswerForEDD_AdminPageFrameworkRepeatableSectionsOptions[ _sSectionsContainerID ];
        ...
        $( _oThis ).find( '.repeatable-section-add-button' ).click( function() {
            ...
            $( this ).addDiscountByAnswerForEDD_AdminPageFrameworkRepeatableSection();
        ...
        $( _oThis ).find( '.repeatable-section-remove-button' ).click( function() {
            $( this ).removeDiscountByAnswerForEDD_AdminPageFrameworkRepeatableSection();
            return false; // will not click after that
        });     
        
        // If the number of sections is less than the set minimum value, add sections. 
        var _sSectionID           = _oThis.find( '.repeatable-section-add-button' ).first().closest( '.discount-by-answer-for-easy-digital-downloads-section' ).attr( 'id' );
        var _nCurrentSectionCount = jQuery( '#' + _sSectionsContainerID ).find( '.discount-by-answer-for-easy-digital-downloads-section' ).length;
        if ( _aOptions[ 'min' ] > 0 && _nCurrentSectionCount > 0 ) {
            if ( ( _aOptions[ 'min' ] - _nCurrentSectionCount ) > 0 ) {     
                $( '#' + _sSectionID ).addDiscountByAnswerForEDD_AdminPageFrameworkRepeatableSection( _sSectionID );  
            }
        }
     ...
     */    
    $.fn.addDiscountByAnswerForEDD_AdminPageFrameworkRepeatableSection = function( sSectionContainerID ) {
        
        // Local variables
        if ( 'undefined' === typeof sSectionContainerID ) {
            var sSectionContainerID = $( this ).closest( '.discount-by-answer-for-easy-digital-downloads-section' ).attr( 'id' );
        }
        var nodeSectionContainer    = $( '#' + sSectionContainerID );
        var nodeNewSection          = nodeSectionContainer.clone(); // clone without bind events.
        var nodeSectionsContainer   = nodeSectionContainer.closest( '.discount-by-answer-for-easy-digital-downloads-sections' );
        var sSectionsContainerID    = nodeSectionsContainer.attr( 'id' );        
        var nodeTabsContainer       = $( this ).closest( '.discount-by-answer-for-easy-digital-downloads-section-tabs-contents' )
            .children( '.discount-by-answer-for-easy-digital-downloads-section-tabs' )
            .first();
            
        var _iSectionIndex          = nodeSectionsContainer.attr( 'data-largest_index' );
        
        var _iFadein                = $.fn.aDiscountByAnswerForEDD_AdminPageFrameworkRepeatableSectionsOptions[ sSectionsContainerID ][ 'fadein' ];
        var _iFadeout               = $.fn.aDiscountByAnswerForEDD_AdminPageFrameworkRepeatableSectionsOptions[ sSectionsContainerID ][ 'fadeout' ];
        var _bPreserveValues        = $.fn.aDiscountByAnswerForEDD_AdminPageFrameworkRepeatableSectionsOptions[ sSectionsContainerID ][ 'preserve_values' ];
        
        // If the set maximum number of sections already exists, do not add.
        var _sMaxNumberOfSections   = $.fn.aDiscountByAnswerForEDD_AdminPageFrameworkRepeatableSectionsOptions[ sSectionsContainerID ][ 'max' ];
        if ( _sMaxNumberOfSections != 0 && nodeSectionsContainer.find( '.discount-by-answer-for-easy-digital-downloads-section' ).length >= _sMaxNumberOfSections ) {
            var _nodeLastRepeaterButtons = nodeSectionContainer.find( '.discount-by-answer-for-easy-digital-downloads-repeatable-section-buttons' ).last();
        ...
        var _sSectionTabSlug = nodeNewSection.find( '.discount-by-answer-for-easy-digital-downloads-section-caption' ).first().attr( 'data-section_tab' );
        if ( ! _sSectionTabSlug || _sSectionTabSlug === '_default' ) {
            nodeNewSection.find( '.discount-by-answer-for-easy-digital-downloads-section-title' ).not( '.discount-by-answer-for-easy-digital-downloads-collapsible-section-title' ).hide();
        }
        ...
        if( 'function' === typeof nodeNewSection.enableDiscountByAnswerForEDD_AdminPageFrameworkCollapsibleButton ){ 
            nodeNewSection.find( '.discount-by-answer-for-easy-digital-downloads-collapsible-sections-title, .discount-by-answer-for-easy-digital-downloads-collapsible-section-title' ).enableDiscountByAnswerForEDD_AdminPageFrameworkCollapsibleButton();
        }
        ...
        $( nodeNewSection ).find( '.discount-by-answer-for-easy-digital-downloads-field' ).each( function( iFieldIndex ) {
            ...
            $( this ).updateDiscountByAnswerForEDD_AdminPageFrameworkRepeatableFields();
                                        
            // Callback the registered callback functions.
            
            // @deprecated 3.8.8 Kept for backward compatibility.
            $( this ).trigger( 
                'discount-by-answer-for-easy-digital-downloads_added_repeatable_field', 
                [
            ...
            // 3.8.8 
            $( this ).trigger( 
                'discount-by-answer-for-easy-digital-downloads_repeated_field', 
                [
                    1, // call type, 0: repeatable fields, 1: repeatable sections, 
                    jQuery( nodeNewSection ).closest( '.discount-by-answer-for-easy-digital-downloads-sections' )    // model container
                ]
            );              
        ...
        nodeNewSection.updateDiscountByAnswerForEDD_AdminPageFrameworkRepeatableSections();    
        
        // Rebind sortable fields - iterate sortable fields containers.
        nodeNewSection.find( '.discount-by-answer-for-easy-digital-downloads-fields.sortable' ).each( function() {
        ...
        if ( nodeTabsContainer.length > 0 && ! nodeSectionContainer.hasClass( 'is_subsection_collapsible' ) ) {
            ...
            nodeTabsContainer.closest( '.discount-by-answer-for-easy-digital-downloads-section-tabs-contents' ).createTabs( 'refresh' );
        ...
        var _incrementAttributes = function( oElement, iSectionsCount, oSectionsContainer ) {
            ...
            $( oElement ).find( 'tr.discount-by-answer-for-easy-digital-downloads-fieldrow, .discount-by-answer-for-easy-digital-downloads-fieldset, .discount-by-answer-for-easy-digital-downloads-fields, .discount-by-answer-for-easy-digital-downloads-field, table.form-table, input,textarea,select' )
                .incrementAttribute( 
                    'id', 
                    iSectionsCount,
                    _sSectionIDModel
            ...
            $( oElement ).find( '.discount-by-answer-for-easy-digital-downloads-fields' ).incrementAttribute( 
                'data-field_tag_id_model',
                iSectionsCount,
                _sSectionIDModel
            );
            $( oElement ).find( '.discount-by-answer-for-easy-digital-downloads-fields' ).incrementAttributes( 
        ...
        // @todo this may be able to be removed
            $( oElement ).find( '.discount-by-answer-for-easy-digital-downloads-fieldset' ).incrementAttribute( 
                'data-field_id',
                iSectionsCount,
                _sSectionIDModel
            );
     ...
     */
    $.fn.removeDiscountByAnswerForEDD_AdminPageFrameworkRepeatableSection = function() {
        
        // Local variables - preparing to remove the sections container element.
        var nodeSectionContainer    = $( this ).closest( '.discount-by-answer-for-easy-digital-downloads-section' );
        var sSectionContainerID     = nodeSectionContainer.attr( 'id' );
        var nodeSectionsContainer   = $( this ).closest( '.discount-by-answer-for-easy-digital-downloads-sections' );
        var sSectionsContainerID    = nodeSectionsContainer.attr( 'id' );        
        var nodeTabsContainer       = $( this ).closest( '.discount-by-answer-for-easy-digital-downloads-section-tabs-contents' )
            .children( '.discount-by-answer-for-easy-digital-downloads-section-tabs' )
            .first();
        var nodeTabs                = nodeTabsContainer.children( '.discount-by-answer-for-easy-digital-downloads-section-tab' );
        ...
        var _sMinNumberOfSections = $.fn.aDiscountByAnswerForEDD_AdminPageFrameworkRepeatableSectionsOptions[ sSectionsContainerID ][ 'min' ];
        if ( _sMinNumberOfSections != 0 && nodeSectionsContainer.find( '.discount-by-answer-for-easy-digital-downloads-section' ).length <= _sMinNumberOfSections ) {
            var _nodeLastRepeaterButtons = nodeSectionContainer.find( '.discount-by-answer-for-easy-digital-downloads-repeatable-section-buttons' ).last();
        ...
        nodeSectionContainer.fadeOut( _iFadeout, function() { 
            ...
            if ( 1 === _nodeRemoveButtons.length ) {
                ...
                var _sSectionTabSlug = nodeSectionsContainer.find( '.discount-by-answer-for-easy-digital-downloads-section-caption' ).first().attr( 'data-section_tab' );
                if ( ! _sSectionTabSlug || '_default' === _sSectionTabSlug ) {
                    nodeSectionsContainer.find( '.discount-by-answer-for-easy-digital-downloads-section-title' ).first().show();
                }                
            }            
...
var _iSectionIndex = _iIterationIndex;
            ...
            // Call the registered callback functions.
            // @deprecated  3.6.0
            // $( this ).find( '.discount-by-answer-for-easy-digital-downloads-field' ).each( function( iFieldIndex ) {    
...
JAVASCRIPTS;
    ...
    static public function getEnabler($sContainerTagID, $iSectionCount, $asArguments, $oMsg) {
        ...
        new self($oMsg);
        $_oFormatter = new DiscountByAnswerForEDD_AdminPageFramework_Form_Model___Format_RepeatableSection($asArguments, $oMsg);
        $_aArguments = $_oFormatter->get();
        $_sButtons = "<div class='discount-by-answer-for-easy-digital-downloads-repeatable-section-buttons-outer-container'>" . "<div " . self::___getContainerAttributes($_aArguments, $oMsg) . ' >' . "<a " . self::___getRemoveButtonAttributes($sContainerTagID, $oMsg, $iSectionCount) . ">-</a>" . "<a " . self::___getAddButtonAttributes($sContainerTagID, $oMsg, $_aArguments) . ">+</a>" . "</div>" . "</div>" . DiscountByAnswerForEDD_AdminPageFramework_Form_Utility::getModalForDisabledRepeatableElement('repeatable_section_disabled_' . $sContainerTagID, $_aArguments['disabled']);
...
jQuery( document ).ready( function() {
    ...
    // Adds the buttons
    jQuery( '#{$sContainerTagID} .discount-by-answer-for-easy-digital-downloads-section-caption' ).each( function(){
        
        jQuery( this ).show();
        
        var _oButtons = jQuery( $_sButtonsHTML );
        if ( jQuery( this ).children( '.discount-by-answer-for-easy-digital-downloads-collapsible-section-title' ).children( 'fieldset' ).length > 0 ) {
            _oButtons.addClass( 'section_title_field_sibling' );
        }
        var _oCollapsibleSectionTitle = jQuery( this ).find( '.discount-by-answer-for-easy-digital-downloads-collapsible-section-title' );
    ...
    // Update the fields     
    jQuery( '#{$sContainerTagID}' ).updateDiscountByAnswerForEDD_AdminPageFrameworkRepeatableSections( $_aJSArray ); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='discount-by-answer-for-easy-digital-downloads-section-repeatable-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
    static private function ___getContainerAttributes(array $aArguments, $oMsg) {
        $_aAttriubtes = array('class' => self::getClassAttribute('discount-by-answer-for-easy-digital-downloads-repeatable-section-buttons', empty($aArguments['disabled']) ? '' : 'disabled'),);
