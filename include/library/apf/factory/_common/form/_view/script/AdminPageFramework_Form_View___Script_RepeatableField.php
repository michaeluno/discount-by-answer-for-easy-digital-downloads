...
class DiscountByAnswerForEDD_AdminPageFramework_Form_View___Script_RepeatableField extends DiscountByAnswerForEDD_AdminPageFramework_Form_View___Script_Base {
...
(function ( $ ) {
     ...
     */
    $.fn.updateDiscountByAnswerForEDD_AdminPageFrameworkRepeatableFields = function( aSettings ) {
        ...
        var _oRepeatableButtons = $( nodeThis ).find( '.discount-by-answer-for-easy-digital-downloads-repeatable-field-buttons' )
            .filter( function() {                                       
                return $( this ).closest( '.discount-by-answer-for-easy-digital-downloads-fields' ).attr( 'id' ) === _sFieldsContainerID;  // Avoid dealing with nested field's elements.                
            });       
...
// @todo event.preventDefault();        
            ...
            $( this ).addDiscountByAnswerForEDD_AdminPageFrameworkRepeatableField();
...
// @todo event.preventDefault();        
            $( this ).removeDiscountByAnswerForEDD_AdminPageFrameworkRepeatableField();
            return false; // will not click after that
        });

        /* If the number of fields is less than the set minimum value, add fields. */
        var _sFieldID           = _oRepeatableAddButtons.first().closest( '.discount-by-answer-for-easy-digital-downloads-field' ).attr( 'id' );
        var _nCurrentFieldCount = $( '#' + _sFieldsContainerID ).find( '.discount-by-answer-for-easy-digital-downloads-field' )
            .filter( function() {                 
                return $( this ).closest( '.discount-by-answer-for-easy-digital-downloads-fields' ).attr( 'id' ) === _sFieldsContainerID;  // Avoid dealing with nested field's elements.                
            })        
            .length;
        if ( _aOptions[ 'min' ] > 0 && _nCurrentFieldCount > 0 ) {
            if ( ( _aOptions[ 'min' ] - _nCurrentFieldCount ) > 0 ) {     
                $( '#' + _sFieldID ).addDiscountByAnswerForEDD_AdminPageFrameworkRepeatableField( _sFieldID );  
            }
        }
     ...
     */
    $.fn.addDiscountByAnswerForEDD_AdminPageFrameworkRepeatableField = function( sFieldContainerID ) {
        
        if ( 'undefined' === typeof sFieldContainerID ) {
            var sFieldContainerID = $( this ).closest( '.discount-by-answer-for-easy-digital-downloads-field' ).attr( 'id' );
        }

        var nodeFieldContainer  = $( '#' + sFieldContainerID );
        var nodeNewField        = nodeFieldContainer.clone(); // clone without bind events.
        var nodeFieldsContainer = nodeFieldContainer.closest( '.discount-by-answer-for-easy-digital-downloads-fields' );
        ...
        if ( ! _aOptions ) {     
            var _nodeButtonContainer = nodeFieldContainer.find( '.discount-by-answer-for-easy-digital-downloads-repeatable-field-buttons' )
                .filter( function() {                 
                    return $( this ).closest( '.discount-by-answer-for-easy-digital-downloads-fields' ).attr( 'id' ) === _sFieldsContainerID;  // Avoid dealing with nested field's elements.                
                })
                .first();
            _aOptions = {
                ...
                fadeout: _nodeButtonContainer.attr( 'data-preserve_values' ),                
            };               
        }  
        ...
        var _oInnerFields       = nodeFieldsContainer.find( '.discount-by-answer-for-easy-digital-downloads-field' ) 
                                    .filter( function() {                 
                                        return $( this ).closest( '.discount-by-answer-for-easy-digital-downloads-fields' ).attr( 'id' ) === _sFieldsContainerID;  // Avoid dealing with nested field's elements.                
                                    });
        var _oRepeatableButtons = nodeFieldContainer.find( '.discount-by-answer-for-easy-digital-downloads-repeatable-field-buttons' )
                                    .filter( function() {                 
                                        return $( this ).closest( '.discount-by-answer-for-easy-digital-downloads-fields' ).attr( 'id' ) === _sFieldsContainerID;  // Avoid dealing with nested field's elements.                
                                    }); 
         ...
         */
        nodeNewField.updateDiscountByAnswerForEDD_AdminPageFrameworkRepeatableFields();
        ...
        $( nodeNewField ).find( '.discount-by-answer-for-easy-digital-downloads-field' ).addBack().trigger( 
            'discount-by-answer-for-easy-digital-downloads_repeated_field', 
            [ 
                0, // call type, 0 : repeatable fields, 1: repeatable sections
                jQuery( nodeNewField ).closest( '.discount-by-answer-for-easy-digital-downloads-fields' )    // model container
            ]
        );
        ...
        var nodeRemoveButtons = nodeFieldsContainer
            ...
            .filter( function() {                      
                return $( this ).closest( '.discount-by-answer-for-easy-digital-downloads-fields' ).attr( 'id' ) === _sFieldsContainerID;                
            })
        ...
        nodeFieldsContainer.children( '.discount-by-answer-for-easy-digital-downloads-field' ).children( '.delimiter' ).show().last().hide();
        ...
        var _incrementFieldAttributes = function( oElement, oFieldsContainer ) {
            ...
            oElement.find( '.discount-by-answer-for-easy-digital-downloads-field,.discount-by-answer-for-easy-digital-downloads-fields,.discount-by-answer-for-easy-digital-downloads-fieldset' ).incrementAttributes(
     ...
     * Removes a repeatable field.
      This method is called when the user presses the - repeatable button.
     */
    $.fn.removeDiscountByAnswerForEDD_AdminPageFrameworkRepeatableField = function() {
        
        /* Need to remove the element: the field container */
        var nodeFieldContainer  = $( this ).closest( '.discount-by-answer-for-easy-digital-downloads-field' );
        var nodeFieldsContainer = $( this ).closest( '.discount-by-answer-for-easy-digital-downloads-fields' );
        var _sFieldsContainerID = nodeFieldsContainer.attr( 'id' );
        var _aOptions = nodeFieldsContainer.data( 'repeatable' );
