...
class DiscountByAnswerForEDD_AdminPageFramework_Form_View___Script_Form extends DiscountByAnswerForEDD_AdminPageFramework_Form_View___Script_Base {
    static public function getScript() {
        return <<<JAVASCRIPTS
( function( $ ) {

    var _removeDiscountByAnswerForEDD_AdminPageFrameworkLoadingOutputs = function() {

        jQuery( '.discount-by-answer-for-easy-digital-downloads-form-loading' ).remove();
        jQuery( '.discount-by-answer-for-easy-digital-downloads-form-js-on' )
            .hide()
            .css( 'visibility', 'visible' )
            .fadeIn( 200 )
            .removeClass( '.discount-by-answer-for-easy-digital-downloads-form-js-on' );
    ...
    window.onerror = function(){
        ...
        _removeDiscountByAnswerForEDD_AdminPageFrameworkLoadingOutputs();
