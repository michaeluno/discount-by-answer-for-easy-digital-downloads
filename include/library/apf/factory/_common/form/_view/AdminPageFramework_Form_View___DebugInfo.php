...
class DiscountByAnswerForEDD_AdminPageFramework_Form_View___DebugInfo extends DiscountByAnswerForEDD_AdminPageFramework_FrameworkUtility {
    ...
    public function get() {
        ...
        return "<div class='discount-by-answer-for-easy-digital-downloads-info'>" . $this->oMsg->get('debug_info') . ': ' . $this->getFrameworkNameVersion() . "</div>";
    }
