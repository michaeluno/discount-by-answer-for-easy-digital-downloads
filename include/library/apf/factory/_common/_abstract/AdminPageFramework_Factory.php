...
abstract class DiscountByAnswerForEDD_AdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected $oHelpPane;
    protected $oLink;
    protected $_aSubClassPrefixes = array('oForm' => 'DiscountByAnswerForEDD_AdminPageFramework_Form_', 'oPageLoadInfo' => 'DiscountByAnswerForEDD_AdminPageFramework_PageLoadInfo_', 'oResource' => 'DiscountByAnswerForEDD_AdminPageFramework_Resource_', 'oHelpPane' => 'DiscountByAnswerForEDD_AdminPageFramework_HelpPane_', 'oLink' => 'DiscountByAnswerForEDD_AdminPageFramework_Link_',);
    private $_aSubClassNames = array('oProp' => null, 'oDebug' => 'DiscountByAnswerForEDD_AdminPageFramework_Debug', 'oUtil' => 'DiscountByAnswerForEDD_AdminPageFramework_FrameworkUtility', 'oMsg' => 'DiscountByAnswerForEDD_AdminPageFramework_Message', 'oForm' => null, 'oPageLoadInfo' => null, 'oResource' => null, 'oHelpPane' => null, 'oLink' => null,);
    ...
    private function _triggerUndefinedMethodWarning($sMethodName) {
        trigger_error(DiscountByAnswerForEDD_AdminPageFramework_Registry::NAME . ': ' . sprintf(__('The method is not defined: %1$s', $this->oProp->sTextDomain), $sMethodName), E_USER_WARNING);
    }
    public function __toString() {
        return DiscountByAnswerForEDD_AdminPageFramework_FrameworkUtility::getObjectInfo($this);
    }
...
abstract class DiscountByAnswerForEDD_AdminPageFramework_Factory_Model extends DiscountByAnswerForEDD_AdminPageFramework_Factory_Router {
    public function __construct($oProp) {
...
abstract class DiscountByAnswerForEDD_AdminPageFramework_Factory_View extends DiscountByAnswerForEDD_AdminPageFramework_Factory_Model {
    public function __construct($oProp) {
        parent::__construct($oProp);
        new DiscountByAnswerForEDD_AdminPageFramework_Factory_View__SettingNotice($this, $this->oProp->sSettingNoticeActionHook);
    }
...
abstract class DiscountByAnswerForEDD_AdminPageFramework_Factory_Controller extends DiscountByAnswerForEDD_AdminPageFramework_Factory_View {
...
abstract class DiscountByAnswerForEDD_AdminPageFramework_Factory extends DiscountByAnswerForEDD_AdminPageFramework_Factory_Controller {
}
