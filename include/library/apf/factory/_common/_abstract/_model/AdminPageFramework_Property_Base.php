...
abstract class DiscountByAnswerForEDD_AdminPageFramework_Property_Base extends DiscountByAnswerForEDD_AdminPageFramework_FrameworkUtility {
    ...
    private function ___setProperties($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType) {
        ...
        $this->sTextDomain = empty($sTextDomain) ? 'discount-by-answer-for-easy-digital-downloads' : $sTextDomain;
    ...
    private function ___setGlobals() {
        if (!isset($GLOBALS['aDiscountByAnswerForEDD_AdminPageFramework'])) {
            $GLOBALS['aDiscountByAnswerForEDD_AdminPageFramework'] = array('aFieldFlags' => array());
        }
    }
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => DiscountByAnswerForEDD_AdminPageFramework_Registry::NAME, 'sURI' => DiscountByAnswerForEDD_AdminPageFramework_Registry::URI, 'sScriptName' => DiscountByAnswerForEDD_AdminPageFramework_Registry::NAME, 'sLibraryName' => DiscountByAnswerForEDD_AdminPageFramework_Registry::NAME, 'sLibraryURI' => DiscountByAnswerForEDD_AdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => DiscountByAnswerForEDD_AdminPageFramework_Registry::getVersion(), 'sDescription' => DiscountByAnswerForEDD_AdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => DiscountByAnswerForEDD_AdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => DiscountByAnswerForEDD_AdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => DiscountByAnswerForEDD_AdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => DiscountByAnswerForEDD_AdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
    ...
    public function __get($sName) {
        ...
        if ('oUtil' === $sName) {
            $this->oUtil = new DiscountByAnswerForEDD_AdminPageFramework_WPUtility;
            return $this->oUtil;
        }
    }
}
