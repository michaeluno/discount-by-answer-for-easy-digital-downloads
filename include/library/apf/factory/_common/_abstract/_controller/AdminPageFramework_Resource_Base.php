...
abstract class DiscountByAnswerForEDD_AdminPageFramework_Resource_Base extends DiscountByAnswerForEDD_AdminPageFramework_FrameworkUtility {
    ...
    protected $_sClassSelector_Style = 'discount-by-answer-for-easy-digital-downloads-style';
    protected $_sClassSelector_Script = 'discount-by-answer-for-easy-digital-downloads-script';
    ...
    private function _getStyleTag($oCaller, $sIDPrefix) {
        $_sStyle = $this->addAndApplyFilters($oCaller, array("style_common_admin_page_framework", "style_common_{$this->oProp->sClassName}",), DiscountByAnswerForEDD_AdminPageFramework_CSS::getDefaultCSS());
    ...
    private function _getIEStyleTag($oCaller, $sIDPrefix) {
        $_sStyleIE = $this->addAndApplyFilters($oCaller, array("style_ie_common_admin_page_framework", "style_ie_common_{$this->oProp->sClassName}",), DiscountByAnswerForEDD_AdminPageFramework_CSS::getDefaultCSSIE());
    ...
    protected function _printCommonScripts($sIDPrefix, $sClassName) {
        ...
        $_sScript = $this->addAndApplyFilters($this->oProp->oCaller, array("script_common_admin_page_framework", "script_common_{$this->oProp->sClassName}",), DiscountByAnswerForEDD_AdminPageFramework_Property_Base::$_sDefaultScript);
    ...
    public function _replyToAddStyle() {
        ...
        $this->_printCommonStyles('discount-by-answer-for-easy-digital-downloads-style-common', get_class());
    ...
    public function _replyToAddScript() {
        ...
        $this->_printCommonScripts('discount-by-answer-for-easy-digital-downloads-script-common', get_class());
