...
class DiscountByAnswerForEDD_AdminPageFramework_FrameworkUtility extends DiscountByAnswerForEDD_AdminPageFramework_WPUtility {
    ...
    static public function getFrameworkVersion($bTrimDevVer = false) {
        $_sVersion = DiscountByAnswerForEDD_AdminPageFramework_Registry::getVersion();
        return $bTrimDevVer ? self::getSuffixRemoved($_sVersion, '.dev') : $_sVersion;
    }
    static public function getFrameworkName() {
        return DiscountByAnswerForEDD_AdminPageFramework_Registry::NAME;
    }
    static public function getFrameworkNameVersion() {
        return self::getFrameworkName() . ' ' . self::getFrameworkVersion();
    }
}
class DiscountByAnswerForEDD_AdminPageFramework_ArrayHandler extends DiscountByAnswerForEDD_AdminPageFramework_FrameworkUtility {
    public $aData = array();
