...
class DiscountByAnswerForEDD_AdminPageFramework_Debug_Base extends DiscountByAnswerForEDD_AdminPageFramework_FrameworkUtility {
...
class DiscountByAnswerForEDD_AdminPageFramework_Debug_Log extends DiscountByAnswerForEDD_AdminPageFramework_Debug_Base {
...
class DiscountByAnswerForEDD_AdminPageFramework_Debug extends DiscountByAnswerForEDD_AdminPageFramework_Debug_Log {
    ...
    static public function dumpArray($asArray, $sFilePath = null) {
        self::showDeprecationNotice('DiscountByAnswerForEDD_AdminPageFramework_Debug::' . __FUNCTION__, 'DiscountByAnswerForEDD_AdminPageFramework_Debug::dump()');
        DiscountByAnswerForEDD_AdminPageFramework_Debug::dump($asArray, $sFilePath);
    }
    static public function getArray($asArray, $sFilePath = null, $bEscape = true) {
        self::showDeprecationNotice('DiscountByAnswerForEDD_AdminPageFramework_Debug::' . __FUNCTION__, 'DiscountByAnswerForEDD_AdminPageFramework_Debug::get()');
        return DiscountByAnswerForEDD_AdminPageFramework_Debug::get($asArray, $sFilePath, $bEscape);
    }
    static public function logArray($asArray, $sFilePath = null) {
        self::showDeprecationNotice('DiscountByAnswerForEDD_AdminPageFramework_Debug::' . __FUNCTION__, 'DiscountByAnswerForEDD_AdminPageFramework_Debug::log()');
        DiscountByAnswerForEDD_AdminPageFramework_Debug::log($asArray, $sFilePath);
    }
    static public function getAsString($mValue) {
        self::showDeprecationNotice('DiscountByAnswerForEDD_AdminPageFramework_Debug::' . __FUNCTION__);
