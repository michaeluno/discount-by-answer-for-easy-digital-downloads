...
class DiscountByAnswerForEDD_AdminPageFramework_WPUtility_URL extends DiscountByAnswerForEDD_AdminPageFramework_Utility {
    ...
    static public function getQueryAdminURL($aAddingQueries = array(), $aRemovingQueryKeys = array(), $sSubjectURL = '') {
        $_sAdminURL = is_network_admin() ? network_admin_url(DiscountByAnswerForEDD_AdminPageFramework_WPUtility_Page::getPageNow()) : admin_url(DiscountByAnswerForEDD_AdminPageFramework_WPUtility_Page::getPageNow());
    ...
    static public function getSRCFromPath($sFilePath) {
        ...
        $_sRelativePath = DiscountByAnswerForEDD_AdminPageFramework_Utility::getRelativePath(ABSPATH, $sFilePath);
...
class DiscountByAnswerForEDD_AdminPageFramework_WPUtility_HTML extends DiscountByAnswerForEDD_AdminPageFramework_WPUtility_URL {
...
class DiscountByAnswerForEDD_AdminPageFramework_WPUtility_Page extends DiscountByAnswerForEDD_AdminPageFramework_WPUtility_HTML {
...
class DiscountByAnswerForEDD_AdminPageFramework_WPUtility_Hook extends DiscountByAnswerForEDD_AdminPageFramework_WPUtility_Page {
...
class DiscountByAnswerForEDD_AdminPageFramework_WPUtility_File extends DiscountByAnswerForEDD_AdminPageFramework_WPUtility_Hook {
...
class DiscountByAnswerForEDD_AdminPageFramework_WPUtility_Option extends DiscountByAnswerForEDD_AdminPageFramework_WPUtility_File {
...
class DiscountByAnswerForEDD_AdminPageFramework_WPUtility_Meta extends DiscountByAnswerForEDD_AdminPageFramework_WPUtility_Option {
...
class DiscountByAnswerForEDD_AdminPageFramework_WPUtility_SiteInformation extends DiscountByAnswerForEDD_AdminPageFramework_WPUtility_Meta {
...
class DiscountByAnswerForEDD_AdminPageFramework_WPUtility_SystemInformation extends DiscountByAnswerForEDD_AdminPageFramework_WPUtility_SiteInformation {
...
class DiscountByAnswerForEDD_AdminPageFramework_WPUtility extends DiscountByAnswerForEDD_AdminPageFramework_WPUtility_SystemInformation {
