...
abstract class DiscountByAnswerForEDD_AdminPageFramework_TermMeta_Router extends DiscountByAnswerForEDD_AdminPageFramework_TaxonomyField_Controller {
}
abstract class DiscountByAnswerForEDD_AdminPageFramework_TermMeta_Model extends DiscountByAnswerForEDD_AdminPageFramework_TermMeta_Router {
    ...
    private function _getSavedTermMetas($iTermID, array $aFieldsets) {
        $_oMetaData = new DiscountByAnswerForEDD_AdminPageFramework_TermMeta_Model___TermMeta($iTermID, $this->oForm->aFieldsets);
...
abstract class DiscountByAnswerForEDD_AdminPageFramework_TermMeta_View extends DiscountByAnswerForEDD_AdminPageFramework_TermMeta_Model {
...
abstract class DiscountByAnswerForEDD_AdminPageFramework_TermMeta_Controller extends DiscountByAnswerForEDD_AdminPageFramework_TermMeta_View {
}
abstract class DiscountByAnswerForEDD_AdminPageFramework_TermMeta extends DiscountByAnswerForEDD_AdminPageFramework_TermMeta_Controller {
    protected $_sStructureType = 'term_meta';
    public function __construct($asTaxonomySlug, $sCapability = 'manage_options', $sTextDomain = 'discount-by-answer-for-easy-digital-downloads') {
