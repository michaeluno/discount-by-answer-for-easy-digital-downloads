...
class DiscountByAnswerForEDD_AdminPageFramework_Property_page_meta_box extends DiscountByAnswerForEDD_AdminPageFramework_Property_post_meta_box {
    ...
    public function __construct($oCaller, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'discount-by-answer-for-easy-digital-downloads', $sStructureType = 'page_meta_box') {
        unset($this->oAdminPage, $this->aHelpTabs);
        parent::__construct($oCaller, $sClassName, $sCapability, $sTextDomain, $sStructureType);
        $GLOBALS['aDiscountByAnswerForEDD_AdminPageFramework']['aMetaBoxForPagesClasses'] = $this->getElementAsArray($GLOBALS, array('aDiscountByAnswerForEDD_AdminPageFramework', 'aMetaBoxForPagesClasses'));
        $GLOBALS['aDiscountByAnswerForEDD_AdminPageFramework']['aMetaBoxForPagesClasses'][$sClassName] = $oCaller;
    }
    ...
    private function _getOwnerObjectOfPage($sPageSlug) {
        $_aPageClasses = $this->getElementAsArray($GLOBALS, array('aDiscountByAnswerForEDD_AdminPageFramework', 'aPageClasses'));
