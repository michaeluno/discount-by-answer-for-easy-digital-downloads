...
abstract class DiscountByAnswerForEDD_AdminPageFramework_MetaBox_Router extends DiscountByAnswerForEDD_AdminPageFramework_Factory {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'discount-by-answer-for-easy-digital-downloads') {
...
abstract class DiscountByAnswerForEDD_AdminPageFramework_MetaBox_Model extends DiscountByAnswerForEDD_AdminPageFramework_MetaBox_Router {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'discount-by-answer-for-easy-digital-downloads') {
    ...
    public function _replyToGetSavedFormData() {
        $_oMetaData = new DiscountByAnswerForEDD_AdminPageFramework_MetaBox_Model___PostMeta($this->_getPostID(), $this->oForm->aFieldsets);
...
abstract class DiscountByAnswerForEDD_AdminPageFramework_MetaBox_View extends DiscountByAnswerForEDD_AdminPageFramework_MetaBox_Model {
...
abstract class DiscountByAnswerForEDD_AdminPageFramework_MetaBox_Controller extends DiscountByAnswerForEDD_AdminPageFramework_MetaBox_View {
...
abstract class DiscountByAnswerForEDD_AdminPageFramework_MetaBox extends DiscountByAnswerForEDD_AdminPageFramework_MetaBox_Controller {
