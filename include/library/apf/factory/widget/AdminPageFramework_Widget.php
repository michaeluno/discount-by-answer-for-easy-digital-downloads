...
abstract class DiscountByAnswerForEDD_AdminPageFramework_Widget_Router extends DiscountByAnswerForEDD_AdminPageFramework_Factory {
...
abstract class DiscountByAnswerForEDD_AdminPageFramework_Widget_Model extends DiscountByAnswerForEDD_AdminPageFramework_Widget_Router {
    ...
    public function _replyToRegisterWidget() {
        ...
        $GLOBALS['wp_widget_factory']->widgets[$this->oProp->sClassName] = new DiscountByAnswerForEDD_AdminPageFramework_Widget_Factory($this, $this->oProp->sWidgetTitle, $this->oUtil->getAsArray($this->oProp->aWidgetArguments));
        $this->oProp->oWidget = $GLOBALS['wp_widget_factory']->widgets[$this->oProp->sClassName];
    }
}
abstract class DiscountByAnswerForEDD_AdminPageFramework_Widget_View extends DiscountByAnswerForEDD_AdminPageFramework_Widget_Model {
...
abstract class DiscountByAnswerForEDD_AdminPageFramework_Widget_Controller extends DiscountByAnswerForEDD_AdminPageFramework_Widget_View {
...
abstract class DiscountByAnswerForEDD_AdminPageFramework_Widget extends DiscountByAnswerForEDD_AdminPageFramework_Widget_Controller {
    protected $_sStructureType = 'widget';
    public function __construct() {
        $_sThisClassName = get_class($this);
        $_bAssumedAsWPWidget = 0 === func_num_args();
        $_aDefaults = array('', array(), 'edit_theme_options', 'discount-by-answer-for-easy-digital-downloads');
    ...
    private function ___setProperties($aParameters, $sThisClassName, $_bAssumedAsWPWidget) {
        ...
        $_sPropertyClassName = isset($this->aSubClassNames['oProp']) ? $this->aSubClassNames['oProp'] : 'DiscountByAnswerForEDD_AdminPageFramework_Property_' . $this->_sStructureType;
