...
class DiscountByAnswerForEDD_AdminPageFramework_PointerToolTip extends DiscountByAnswerForEDD_AdminPageFramework_FrameworkUtility {
    ...
    public function _replyToInsertInternalScript() {
        echo "<script type='text/javascript' class='discount-by-answer-for-easy-digital-downloads-pointer-tool-tip'>" . '/* <![CDATA[ */' . $this->_getInternalScript(self::$aPointers) . '/* ]]> */' . "</script>";
    }
