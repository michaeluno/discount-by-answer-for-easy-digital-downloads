...
abstract class DiscountByAnswerForEDD_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('DiscountByAnswerForEDD_AdminPageFramework_RegisterClasses', false)) {
            return;
        }
        new DiscountByAnswerForEDD_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
